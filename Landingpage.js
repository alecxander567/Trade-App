        ...
        <View style={styles.featuresSection}>
          ...
          <View style={styles.featureCard}>
            ...
            <Text style={styles.featureDesc}>
              Connect instantly with other traders and discuss item conditions in real time.
            </Text>
          </View>
          <View style={styles.featureCard}>
            <Text style={styles.featureTitle}>🤝 Make Trade Partners</Text>
            <Text style={styles.featureDesc}>
              Build relationships and trade partners along the way to access valuable items.
            </Text>
          </View>
          <View style={styles.featureCard}>
            <Text style={styles.featureTitle}>✨ Interesting Items</Text>
            <Text style={styles.featureDesc}>
              Explore other people's traded items and discover unique additions for your collection.
            </Text>
          </View>
        </View>
