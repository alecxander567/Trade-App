...
import { View, Text, StyleSheet, TouchableOpacity, Image, ScrollView, StatusBar, Modal, TextInput } from 'react-native';
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <TouchableOpacity style={styles.modalCloseButton} onPress={() => setLoginModalVisible(false)}>
                            <Text style={styles.modalCloseButtonText}>Cancel</Text>
                        </TouchableOpacity>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#0B0B1D' },
    navbar: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 15, paddingHorizontal: 20, backgroundColor: '#1C1C3A' },
    navTitle: { fontSize: 24, fontWeight: 'bold', color: '#fff' },
    navButtons: { flexDirection: 'row', alignItems: 'center' },
    navButton: { marginLeft: 15, paddingVertical: 6, paddingHorizontal: 12, borderRadius: 6, borderWidth: 1, borderColor: '#6C63FF' },
    navButtonText: { color: '#6C63FF', fontWeight: 'bold' },
    signUpButton: { backgroundColor: '#6C63FF' },
    signUpButtonText: { color: '#fff' },
    hero: { alignItems: 'center', justifyContent: 'center', paddingVertical: 60, backgroundColor: '#1C1C3A' },
    logo: { width: 90, height: 90, marginBottom: 20 },
    title: { fontSize: 32, fontWeight: 'bold', color: '#fff', marginBottom: 8 },
    subtitle: { fontSize: 16, color: '#CFCFCF', textAlign: 'center', paddingHorizontal: 40, marginBottom: 20 },
    ctaButton: { backgroundColor: '#6C63FF', paddingVertical: 12, paddingHorizontal: 40, borderRadius: 30, marginTop: 10 },
    ctaText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
    featuresSection: { backgroundColor: '#0B0B1D', paddingVertical: 40, paddingHorizontal: 20 },
    sectionTitle: { fontSize: 22, fontWeight: 'bold', color: '#fff', marginBottom: 20, textAlign: 'center' },
    featureCard: { backgroundColor: '#1C1C3A', borderRadius: 12, padding: 20, marginBottom: 16 },
    featureTitle: { fontSize: 18, color: '#6C63FF', fontWeight: 'bold', marginBottom: 8 },
    featureDesc: { color: '#CFCFCF', fontSize: 14, lineHeight: 20 },
    footer: { paddingVertical: 20, borderTopWidth: 1, borderTopColor: '#2E2E50', alignItems: 'center' },
    footerText: { color: '#CFCFCF', fontSize: 12 },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', alignItems: 'center' },
    modalContent: { width: '85%', backgroundColor: '#1C1C3A', borderRadius: 12, padding: 20 },
    modalTitle: { fontSize: 24, fontWeight: 'bold', color: '#fff', marginBottom: 20, textAlign: 'center' },
    input: { backgroundColor: '#0B0B1D', color: '#fff', padding: 12, borderRadius: 8, marginBottom: 12 },
    modalButton: { backgroundColor: '#6C63FF', padding: 12, borderRadius: 8, alignItems: 'center', marginBottom: 10 },
